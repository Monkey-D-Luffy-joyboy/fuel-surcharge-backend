// Shared pricing logic. Both api/bookings.js (the real, authoritative charge amount) and
// api/estimate.js (the live on-screen estimate while filling out the form) import from
// here, so the two can never drift apart the way the front-end's old hardcoded copy did.
